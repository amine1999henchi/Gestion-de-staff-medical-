...
?>
<button type="button" class="btn btn-warning btn-circle float-left ml-2" data-toggle="modal" data-target="#exampleModal<?php echo $staff['idStaff'] ?>">
    <i class="fas fa-edit"></i>
</button>
<!-- Modal1 -->
<div class="modal fade" id="exampleModal<?php echo $staff['idStaff'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" value="<?php echo $staff['idStaff'] ?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form Start -->
                <form method="POST" action="updatestaff.php" class="form" enctype="multipart/from-data">
